...
\begin{align*}
	\rho_0 =& \Lambda \frac{3}{8 \pi G} \text{, $\Lambda$ is knows as the cosmological constant}
\end{align*}
...
The closer that experiments observe $w=-1$, closer they get to saying that vacuum energy dominates.
...
Let us study the case where the vacuum energy density is the \emph{only} density.

\url{https://youtu.be/GgKGPyFL-TM?t=3534}
