...
\begin{figure}[H]
	\caption[A box of photons]{A box of photons. They bounce of walls, lose no energy, an exert pressure on walls}
	\includegraphics[width=0.8\textwidth]{cosmo-5-box-photons}
\end{figure}

Let us pretend that all phones have the same energy (we will find out this doesn't matter; it is approximately true of photons are in thermal equilibrium). Let energy per photon be $\epsilon$, and momentum per photon $\vec{\pi}$\footnote{Not "the" $\pi$}.

\url{https://youtu.be/GgKGPyFL-TM?t=1385}
