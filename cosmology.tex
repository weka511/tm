...
What is energy is negative? Equation \eqref{eq:full:friedmann} becomes:

\begin{align*}
	\frac{\dot{a}}{a}^2  =& \frac{8\pi\nu G}{a^3} - \frac{C}{a^2} 
\end{align*}
Now there is a point where $\dot{a}=0$.
...
The matter dominated universe was the classic cosmology until other things were discovered.
