...
\appendix
\section{Calcs}
Using \cite{san2021pytearcat}
\begin{align*}
	ds^2 =& -1 \cdot dt^2+a^{2}{\left(t \right)} \cdot dr^2+r^{2} a^{2}{\left(t \right)} \cdot d\theta^2+r^{2} a^{2}{\left(t \right)} \sin^{2}{\left(\theta \right)} \cdot d\phi^2\\
	{G}{}_{0}\,{}_{0}\, =& \frac{3 \left(\frac{d}{d t} a{\left(t \right)}\right)^{2}}{a^{2}{\left(t \right)}}\\
	{G}{}_{1}\,{}_{1}\, =& - 2 a{\left(t \right)} \frac{d^{2}}{d t^{2}} a{\left(t \right)} - \left(\frac{d}{d t} a{\left(t \right)}\right)^{2}\\
	{G}{}_{2}\,{}_{2}\, =& - r^{2} \cdot \left(2 a{\left(t \right)} \frac{d^{2}}{d t^{2}} a{\left(t \right)} + \left(\frac{d}{d t} a{\left(t \right)}\right)^{2}\right)\\
	{G}{}_{3}\,{}_{3}\, =& - r^{2} \cdot \left(2 a{\left(t \right)} \frac{d^{2}}{d t^{2}} a{\left(t \right)} + \left(\frac{d}{d t} a{\left(t \right)}\right)^{2}\right) \sin^{2}{\left(\theta \right)}
\end{align*}
