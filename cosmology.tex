...
Why isn't the universe completely smooth? The amount of inflation would have smoothed the universe enough to eliminate the structure we have. Not galaxies, not clusters, but superclusters of superclusters.

The structure is largely understood through simulations. These start by assuming that the universe was not completely smooth, and that it had something called to fluctuation spectrum. Allow gravity and motion to evolve, and see that it produces structure. On bigger scales, gravity is not that important.

\url{https://youtu.be/hADOY0TzLic?t=6301}

\begin{figure}[H]
	\caption[Large scale structure of the Universe]{LS gave some images to the students that showed the Large scale structure of the Universe. Figures \ref{fig:cosmo-9-super}, \ref{fig:cosmo-9-simulation}, and \ref{fig:cosmo-9-pool} are images that I have found that appear to tell the same story.}
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{Superclusters\cite{powell2024superclusters}}\label{fig:cosmo-9-super}
		\includegraphics[width=\textwidth]{Superclusters_atlasoftheuniverse}
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{Simulation\cite{pontzen2014computer}}\label{fig:cosmo-9-simulation}
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{pool\cite{inaglory2024caustics}}\label{fig:cosmo-9-pool}
