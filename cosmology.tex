...
There is another symmetry of nature that isn't really a symmetry. Sakharov wrote a copuld of years after it was discovered that it wasn't a symmetry: particle-antiparticle reflection symmetry. This says that if particles are replaced with reflection we can't tell the difference.
...
Imagine (before Sakharov) that $CP$ was a symmetry.
\section{Inflation}
