...
Figures \ref{fig:cosmo-9-super}, \ref{fig:cosmo-9-simulation}, and \ref{fig:cosmo-9-pool} have a remarkable symmetry, which can be explained by caustics.
...
If we were dealing with only one dimension, caustics would be bright spots.

\url{https://youtu.be/hADOY0TzLic?t=6757}
