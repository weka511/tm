...
We change the volume adiabatically, doing work. From \cite{susskind2013statistical}[Lecture 6]:

\begin{align*}
	dE =& -P dV + \underbrace{T dS}_\text{Adiabatic $\implies dS=0$}\\
	=& \rho dV + V d\rho \text{, from \eqref{eq:E:rho:V}}\\
...
\begin{align*}
	V d\rho =& - (1+w)\rho dV \text{, from \eqref{eq:p:w:rho}. Regrouping}\\
