...
\begin{figure}[H]
	\caption[Unit box with photon]{Unit box with photon. Expand slowly, and wavelength grows in proportion; number remains unchanged.}\label{fig:unit:box}
	\includegraphics[width=0.6\textwidth]{cosmo-2-unit-box}
\end{figure}
...
\begin{figure}[H]
	\caption{Comparison of Radiation and Matter dominated universes}
