...
General Relativity starts with a metric, and we will assum that space and time aren't mixed with each other in the metric. The metric has one of these three forms:
\begin{align*}
...
\url{https://youtu.be/UpFRJ4g3S0M?t=2786}
