...
\begin{itemize}
	...
	\item $k=-1$
\end{itemize}
Where $k$ is overall curvature (ignoring little bumps).
...
\begin{align*}
	ds^2 =& - dt^2 + a(t)^2 d\Omega_3^2 \text{, $k=1$, or}\\
	ds^2 =& - dt^2 + a(t)^2 dx^2 + dy^2 +dz^2 \text{, $k=0$, or}\\
	ds^2 =& - dt^2 + a(t)^2 d\mathcal{H}_3^2 \text{, $k=-1$}	
\end{align*}
In all three cases:
\begin{align*}
	D =& a(t) d\theta\\
...
We can interpret $k$ is curvature, rather than energy.
...
\url{https://youtu.be/UpFRJ4g3S0M?t=5350}.
