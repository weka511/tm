...
\end{itemize}
 ...
 If, in particular, at some level charge conjugation symmetry is violated, two processes, e.g. but Figures \ref{fig:cosmo-8-anti-proton-decay} and  \ref{fig:cosmo-8-proton-decay}, need not be the same. Somewhere in the laws of physics there is a bias towards matter. WE need to add this to baryon number violation to give it a push\footnote{Sakharov wrote down his conditions within a year or two of the discovery of CP violation}. 
 
 \url{https://youtu.be/gdFldkitkJA?t=3138}
