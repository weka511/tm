...
\begin{figure}[H]
	...
	\includegraphics[width=0.8\textwidth]{cosmo-3-1-sphere}
\end{figure}
...
The 2-sphere is also homogeneous. Every point on the surface of the spehere is the same as any other point. It has uniform curvature. If you wakk around you come back to the same space.
