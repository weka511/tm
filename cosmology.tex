...
Simulations start by assuming that the universe was not completely smooth, and that it had something called to fluctuation spectrum. Allow gravity and motion to evolve, and see that it produces structure. On bigger scales, structures emerge that don't depend on gravity.
