...
\begin{table}[H]
	...
	\begin{center}
		\begin{tabular}{|l|l|l|}\hline
			...
			C&&$\frac{1}{2}\big(\tau_1+1\big)$\\ \hline
		\end{tabular}
	\end{center}
\end{table}
...
\begin{align*}
	...
	=&\frac{1}{4}
\end{align*}
Substituting this and (\ref{eq:bell:lhs:approx}) in (\ref{eq:bell:ineq:classical}), we get $0.17 \ge 0.25$--a contradiction. The Singlet violates Bell's inequality, which means that there is no possibility of an underlying classical way of thinking about QM based on set theory. It can not be the statistical theory of some underlying complicated, chaotic, classical system. 
