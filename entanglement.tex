...
Classically we'd only get the first and last term, but in quantum mechanics we have the other two as well. By symmetry we might argues that $\psi_0$ and $\phi_0$ should be the same.
\begin{align*}
...
\url{https://youtu.be/xXBx8_19nyw?t=5698}
