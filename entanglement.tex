...
\begin{proof}
	\begin{figure}[H]
		\caption{Bell's Inequality--\cite{wiki2020bell}}\label{fig:bell}
		\includegraphics[width=0.8\textwidth]{1200px-Bell's_Theorem_JCB.jpg}
	\end{figure}
See Figure \ref{fig:bell}.
\end{proof}
What ia amazing is that Bell's Inequality can be violated!

\url{https://youtu.be/XlLsTaJn9AQ?t=1430}
