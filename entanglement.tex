...
\url{https://youtu.be/xXBx8_19nyw?t=4513}
...
Can't electron become entangle with an atom in the surround to the slit? Yes, and it destroys the interference pattern. Photons are easier, as they don't interact so much. Electric field of electron may interact with something: if the disturbance is enough that you can tell which slit the electron went through, then you completely destroy the interference pattern. \begin{itemize}
	\item If electron goes through slit and moves the probability distribution of some degree of freedom enough that you know the slit, then you lose interference.
	\item If it shifts just a little bit, so you don't know which slit, then interference will not be completely destroyed.
\end{itemize}

Iy is a matter of degree: freeze things, pout everything into ground state, so nothing is easly disturbed, then you can create pretty much the idealized situation where, after you have gone through, there is nothing that has been recorded. If there is an energy gap, and the photon/electron has low energy, it might not be able to make the disturbance: so you have the interference pattern.
