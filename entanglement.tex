...
\end{align*}
LS gets 0.25 for RHS. contradicting (\ref{eq:bell:ineq:classical}). Verify calc! Singlet violates Bell's inequality, which mans thatthere is no possibility of an underlying classical way of thinking about QM based on set theory. It can not be the statistical theory of dome underlying complicated chaotic classical system. 
