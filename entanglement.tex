...
\begin{figure}[H]
	...
	\includegraphics[width=0.8\textwidth]{1200px-Bell's_Theorem_JCB}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{center}
			...
			\draw[black, thick] (0,4) -- (-1,5) -- (-1,1) -- (0,2);
			\draw[black, thick] (6,5) -- (6.5,5.5) -- (6.5,3.5) -- (6,4);
			\draw[black, thick] (6,1) -- (6.5,0.5) -- (6.5,2.5) -- (6,2);
			\node at (-1.5,3) {$\ket{u}$};
			\node at (7,1.5) {$\ket{u}$};
			\node at (7,4.5) {$\ket{u}$};
		\end{tikzpicture}
...
\begin{figure}[H]
	\begin{center}
		\caption[Two slit experiment]{The two slit experiment. Electron starts in one of 7 positions and moves to the right. When an electron meets the 2nd column it bounces back, unless it is in one of the two positions designated as slits.}\label{fig:ent-2-slit}
			...
			\filldraw[black] (0,3) circle (2pt) node[anchor=west]{};
			\filldraw[black] (0,4) circle (2pt) node[anchor=west]{};
			\filldraw[black] (0,5) circle (2pt) node[anchor=west]{};
			\filldraw[black] (0,6) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,0) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,1) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,2) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,3) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,4) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,5) circle (2pt) node[anchor=west]{};
			\filldraw[black] (3,6) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,0) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,1) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,2) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,3) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,4) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,5) circle (2pt) node[anchor=west]{};
			\filldraw[black] (6,6) circle (2pt) node[anchor=west]{};
			\draw[gray, thick, ->] (0,3) -- (3,4);
			\draw[gray, thick, ->] (0,3) -- (3,2);
			\draw[gray, thick, ->] (3,4) -- (6,4);
			\draw[gray, thick, ->] (3,2) -- (6,4);
		\end{tikzpicture}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\caption{Apparatus to change sign $\ket{0} \rightarrow \ket{-1} - \ket{+1}$}\label{fig:change:sign}
			...
			\draw[gray, thick, ->] (0,3) -- (3,4);
			\draw[gray, thick, ->] (0,3) -- (3,2);
			\draw[gray, dashed, ->] (3,4) -- (6,4);
			\draw[gray, dashed, ->] (3,2) -- (6,4);
			\draw[gray, dashed, ->] (3,4) -- (6,5);
			\draw[gray, dashed, ->] (3,2) -- (6,5);
		\end{tikzpicture}
	\end{center}
\end{figure}
