...
\begin{proof}
	...
	\begin{lemma}\label{lemma:coeff:trace}
		The coefficient of $\lambda^{n-1}$ in \eqref{eq:eigen:determinant} is the negative trace of the matrix, $-\sum_{i=1}^{n}a_{ii}$, and the coefficient of $\lambda^{n}$ is $1$.
	\end{lemma}
