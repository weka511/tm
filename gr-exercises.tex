...
From (\ref{eq:Rtt}) and (\ref{eq:Rrr})
...
Now from (\ref{eq:schwartzschild:ansatz})
\begin{align*}
	dt^2 =& \big(a + \frac{b}{r}\big) dt^2 - \frac{c}{a + \frac{b}{r}} dr^2 -r^2 d  \Omega^2 \text{, which should be Minkowskian at infinity, i.e:}\\
	a =& \frac{c}{a}=1
\end{align*}
