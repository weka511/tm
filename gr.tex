...
\begin{appendices}
	...
	\begin{proof}
		...
		Because it has a temperature, black hole radiates black body radiation. Since information is finite we have to modify our picture--see Figure \ref{fig:ibh-horizon-planck}.
		\begin{figure}[H]
			\begin{center}
