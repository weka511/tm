...
\begin{appendices}
	...
	\begin{proof}
		...
		\begin{align*}
			...
			T =& \frac{\hslash}{8 \pi M G} \text{ \cite{hawking1975particle}.}
		\end{align*}
		...
		\begin{figure}[H]
			\begin{center}
				\caption[Cannot store anything on a  scale smaller than Planck Length]{Cannot store anything on a vertical scale smaller than Planck Length}\label{fig:ibh-horizon-planck}
