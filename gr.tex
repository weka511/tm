...
\begin{appendices}
	The appendices contain calculations arising from the lectures.
	...
	\begin{align*}
		...
		=&-\tan \theta \numberthis \label{eq:Gamma:pHtHpH}\\
		\Gamma\indices{^\phi_{\phi\theta}} =& -\tan \theta \numberthis \label{eq:Gamma:pHpHtH}
	\end{align*}
	
	\subsection{Riemann \& Ricci Tensors}
	
	From \cite{akhmedov2016lectures}
	\begin{align*}
	...
	\begin{align*}
		R_{tt} =& \partial_\alpha \Gamma\indices{^\alpha_{tt}} - \partial_t \Gamma\indices{^\alpha_{t\alpha}} + \Gamma\indices{^\alpha_{\gamma\alpha}} \Gamma\indices{^\gamma_{tt}} - \Gamma\indices{^\alpha_{\gamma t}} \Gamma\indices{^\gamma_{t\alpha}} \\
		=& \partial_r \Gamma\indices{^r_{tt}} - \partial_t \Gamma\indices{^r_{tr}} + \big[\Gamma\indices{^t_{rt}}+\Gamma\indices{^r_{rr}} + \Gamma\indices{^\theta_{r\theta}}\big] \Gamma\indices{^r_{tt}} - 2\Gamma\indices{^t_{r t}} \Gamma\indices{^r_{tt}} \\
		=& - \frac{1}{2} \partial_r \big[ \nu^\prime(r) e^{\nu(r)-\lambda(r)}\big] - \cancel{\partial_t \Gamma\indices{^r_{tr}}} + \big[\bcancel{\Gamma\indices{^t_{rt}}}+\Gamma\indices{^r_{rr}} + \Gamma\indices{^\theta_{r\theta}}\big] \Gamma\indices{^r_{tt}} - \bcancel{2}\Gamma\indices{^t_{r t}} \Gamma\indices{^r_{tt}}\\
		=& -\frac{1}{2}\big[\nu^{\prime\prime} + \nu^\prime\big(\nu^\prime - \lambda^\prime \big)\big]e^{\nu-\lambda} + \big[\frac{\lambda^\prime}{2} + \frac{1}{r}-\frac{\nu\prime}{2}  \big] \big[- \frac{1}{2} \nu^\prime e^{\nu-\lambda}\big]\\
		=& -\frac{1}{2}\bigg[\nu^{\prime\prime} + \big(\nu^\prime\big)^2 - \nu^\prime\lambda^\prime + \frac{\nu^\prime\lambda^\prime}{2} + \frac{\nu^\prime}{r} - \frac{ \big(\nu^\prime\big)^2}{2}\bigg]e^{\nu-\lambda}\\
		=& -\frac{1}{2}\bigg[\nu^{\prime\prime}  -  \frac{\nu^\prime\lambda^\prime}{2} + \frac{\nu^\prime}{r} + \frac{ \big(\nu^\prime\big)^2}{2}\bigg]e^{\nu-\lambda}
	\end{align*}
	
	\begin{align*}
		R_{rr} =& \partial_\alpha \Gamma\indices{^\alpha_{rr}} - \partial_\nu \Gamma\indices{^\alpha_{\mu\alpha}} + \Gamma\indices{^\alpha_{\gamma\alpha}} \Gamma\indices{^\gamma_{\mu\nu}} - \Gamma\indices{^\alpha_{\gamma\nu}} \Gamma\indices{^\gamma_{\mu\alpha}}
	\end{align*}
	
	\begin{align*}
		R_{\theta\theta} =& \partial_\alpha \Gamma\indices{^\alpha_{\theta\theta}} - \partial_\nu \Gamma\indices{^\alpha_{\mu\alpha}} + \Gamma\indices{^\alpha_{\gamma\alpha}} \Gamma\indices{^\gamma_{\mu\nu}} - \Gamma\indices{^\alpha_{\gamma\nu}} \Gamma\indices{^\gamma_{\mu\alpha}}
	\end{align*}
	...
	We will look for plane wave solutions propagating along the $z$ axis, of form (\ref{eq:sine_wave})
	\begin{align*}
		h_{\mu\nu}(x,t)=&h^0_{\mu\nu} \sin\big(k(t-z)\big)\\
		\partial_0^2 h_{\mu\nu}=& -k^2 h_{\mu\nu}\\
		\partial_z^2 h_{\mu\nu}=& -k^2 h_{\mu\nu}\\
	...
	\begin{align*}
		\sum_i&\big[\underbrace{\partial_i\partial_\beta h_{i\delta}}_\text{(a)} - \underbrace{\partial_i\partial_i h_{\beta\delta}}_\text{(b)} -  \underbrace{\partial_\delta\partial_\beta h_{ii}}_\text{(c)} + \underbrace{\partial_\delta\partial_i h_{\beta i}\big]}_\text{(d)}\\
		&=\underbrace{\partial_0\partial_\beta h_{0\delta}}_\text{(e)}- \underbrace{\partial_0\partial_0 h_{\beta\delta}}_\text{(f)} - \underbrace{\partial_\delta\partial_\beta h_{00}}_\text{(g)} + \underbrace{\partial_\delta\partial_0 h_{\beta 0}}_\text{(h)} \\
		&\underbrace{\partial_z\partial_t h_{zt}}_\text{(a)} - \underbrace{\partial_z\partial_z h_{tt}}_\text{(b)} -  \underbrace{\partial_t\partial_t \sum_i h_{ii}}_\text{(c)} + \underbrace{\partial_t\partial_z h_{0t}}_\text{(d)}\\
