...
\begin{figure}[H]
	\begin{center}
		...
		\begin{tikzpicture}[scale=0.5]
			...
			\draw[] (0,-0.5) -- (0,6.5) node[above] {$E$};
			\draw[scale=1.0, domain=-2.5:2.5, smooth, variable=\x] plot ({\x}, {\x*\x});
		\end{tikzpicture}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\filldraw[black] (-4,0) circle (2pt) node[anchor=east]{0};
			\filldraw[black] (4,0) circle (2pt) node[anchor=west]{$m_p$ (Planck mass)};
		\end{tikzpicture}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\feynmandiagram [vertical=o1 to i1] {
			i1 [particle=\(q\)] -- [fermion] a -- [fermion] o1,
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		...
		\feynmandiagram[layered layout,horizontal= o1 to in1]{
			in1--[boson]a--b--[boson]o1,
			in2[particle=\(X\)]--a,
			b--o2[particle=\(X\)],
			in2--[opacity=0.0]o2,
		};
	...
	\begin{center}
		...
		\begin{subfigure}[t]{0.45\textwidth}
			\feynmandiagram[vertical = out1 to in1] {
				in1[particle=\(H\)] --[boson] b,
				b -- [fermion] out1 [particle = \(e^{-}\)],
				b -- [fermion] out2 [particle = \(e^{+}\)],
		...
		\begin{subfigure}[t]{0.45\textwidth}
			\feynmandiagram[vertical = out1 to in1] {
				in1 [particle=\(H\)] --[boson] b,
				b -- [fermion] out1 [particle = \(q\)],
				b -- [fermion] out2 [particle = \(\bar{q}\)],
				out1--[opacity=0.0]out2
			};
		\end{subfigure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\feynmandiagram[small,layered layout,horizontal = in1 to b] {
			in1 [particle = \(g\)] -- [gluon] b,
			b -- [fermion] out1 [particle = \(t\)],
			b -- [fermion] out2 [particle = \(\bar{t}\)]
		};
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\feynmandiagram[small,layered layout,horizontal = in1 to b] {
			...
			b -- [fermion] f2 [particle = \(\bar{t}\)],
			f1 -- [fermion] h,
			f2 -- [fermion] h,
			in2[particle = \(g\)] -- [gluon] f2,
			h -- [boson] out1 [particle = \(H\)]
		};
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.3\textwidth}
		\caption{Figure (\subref{fig:2-a3-gluons}) is usually drawn like this, with top quarks going round the loop. }\label{fig:2-a3-higgs-neat}
		\feynmandiagram[small,vertical=out1 to in1]{
			in1 -- [gluon] p2 [particle=\(g\)],
			in2 -- [gluon] p3 [particle=\(g\)],
			p1--p2--p3--p1--[boson]out1[particle=\(H\)],
			in1--[opacity=0.1]in2,
		};
	\end{subfigure}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\feynmandiagram[small,vertical=out1 to in1]{
			in1[particle=\(H\)]--[boson]t1--t2--t3--t1,
			t2 -- [photon] out1  [particle=\(\gamma\)],
			t3 -- [photon] out2  [particle=\(\gamma\)],
			out1--[opacity=0.0]out2,
		};
	\end{center}
\end{figure}
