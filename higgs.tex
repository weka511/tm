...
\begin{figure}[H]
	\begin{center}
		\caption[All known particles are clustered around left of this plot]{All known particles are clustered around left of this plot--so close to zero that we cannot resolve them.}\label{fig:higgs-masses}
		\begin{tikzpicture}
			\draw[black, thick] (-4,0) -- (4,0);
			\filldraw[black] (-4,0) circle (2pt) node[anchor=east]{0};
			\filldraw[black] (4,0) circle (2pt) node[anchor=west]{$m_p$};
		\end{tikzpicture}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\feynmandiagram [horizontal=a to b] {
			...
			a -- [photon] b [particle=\(g\)],
		};
	\end{subfigure}
	\begin{subfigure}[t]{0.3\textwidth}
		\caption{Fermion(even neutrino) emits Z-boson}
		\feynmandiagram [horizontal=a to b] {
			i1 [particle=\(e\nu\)] -- [fermion] a -- [fermion] i2,
...
\begin{figure}[H]
	\begin{center}
		...
		\feynmandiagram[horizontal = a to b] {
			a [particle=\(H\)] --[boson] b,
			b -- [fermion] f1 [particle = \(e^{-}\;q\)],
			b -- [fermion] f2 [particle = \(e^{+}\;\bar{q}\)],
		};
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		...
		\feynmandiagram[small,horizontal = a to h2] {
			a [particle = \(g\)] -- [gluon] b,
			b -- [fermion] f1 [particle = \(t\)],
			b -- [fermion] f2 [particle = \(\bar{t}\)],
			f1 -- [fermion] h,
			f2 -- [fermion] h,
			c [particle = \(g\)] -- [gluon] f2,
			h -- [boson] h2 [particle = \(H\)],
			a -- [opacity=0.0] c,
		};
	\end{subfigure}
	\em
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{More formal version of (\subref{fig:2-a3-gluons}) }\label{fig:2-a3-higgs-neat}
		\feynmandiagram[small,vertical=t2 to t3]{
			a[particle=\(H\)]--[boson]t1--t2--t3--t1,
			t2 -- [gluon] p1 [particle=\(g\)],
			t3 -- [gluon] p2 [particle=\(g\)],
		};
	\end{subfigure}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		...
		\feynmandiagram[small,horizontal'=a to t1]{
			a[particle=\(H\)]--[boson]t1--t2--t3--t1,
			p1 [particle=\(\gamma\)] -- [photon] t2 ,
			p2 [particle=\(\gamma\)]-- [photon] t3 ,
		};
	\end{center}
\end{figure}
